...
import beekoderLogo from '../../assets/Images/random bg img/corner-logo.png'
                            ...
                            <li key={index}>
                                {
                                    link.title === "Services" ? (
                                        ...
                                        <Link to={link?.path}>
                                            <p className={`${matchRoute(link?.path) ? "bg-gradient-to-r from-[#FF512F] to-[#F09819] text-white" : ""} rounded-xl p-1 px-3 `}>
                                                {link.title}
                                            </p>
                                        </Link>)
                                }
